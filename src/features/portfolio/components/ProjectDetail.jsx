            ...
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                ...
                {project.Link ? (
                  ...
                  <div className="inline-flex items-center space-x-2 px-4 md:px-8 py-2.5 md:py-4 rounded-xl border border-gray-700 bg-gray-900/20 text-gray-500 cursor-not-allowed text-sm md:text-base">
